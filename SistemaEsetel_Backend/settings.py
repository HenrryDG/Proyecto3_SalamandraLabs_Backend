"""
Django settings for SistemaEsetel_Backend project.
...
SECRET_KEY = 'django-insecure-(5=4xq@ra(%wg4dv@l6ktt444o%qmsw62vva+x@7=&rr_-tuy@'
...
ROOT_URLCONF = 'SistemaEsetel_Backend.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'Documentacion' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'SistemaEsetel_Backend.wsgi.app'
